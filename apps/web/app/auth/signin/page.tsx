    ...
    <main className="min-h-screen bg-void flex items-center justify-center px-4">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/3 w-72 h-72
                        bg-violet/5 rounded-full blur-3xl" />
      </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 w-full
                         border border-border text-white/80 text-sm py-3 px-4
                         rounded-xl hover:border-teal/30 hover:bg-teal/5
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 w-full
                         border border-border text-white/80 text-sm py-3 px-4
                         rounded-xl hover:border-violet/30 hover:bg-violet/5
                         transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading === "github" ? (
                <Spinner />
...
function Spinner() {
  return (
    <div className="w-4 h-4 border-2 border-teal/30 border-t-teal
